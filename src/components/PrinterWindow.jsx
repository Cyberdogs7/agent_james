...
const PrinterWindow = ({
    ...
    return (
        <div
            ...
            className={`pointer-events-auto  bg-black/80 border border-gold9/20 rounded-2xl shadow-[0_0_30px_rgba(255,215,0,0.1)] overflow-hidden flex flex-col ${activeDragElement === "printer" ? "" : "transition-[left,top] duration-200"}`}
        >
            {/* Header */}
