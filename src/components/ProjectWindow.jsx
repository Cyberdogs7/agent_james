...
const ProjectWindow = ({
    ...
    return (
        <div
            ...
            className={`absolute flex flex-col gap-2 p-4 rounded-xl backdrop-blur-md bg-black/60 border border-gold9/20 ${activeDragElement === "project_window" ? "" : "transition-all duration-200"} select-none
