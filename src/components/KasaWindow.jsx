...
const KasaWindow = ({
    ...
    return (
        <div
            ...
            className={`absolute flex flex-col gap-2 p-4 rounded-xl  bg-black/80 border border-gold9/20 ${activeDragElement === "kasa" ? "" : "transition-[left,top] duration-200"} select-none
