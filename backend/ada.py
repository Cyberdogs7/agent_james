...
"""
    ...
    def _register_tools(self):
        ...
        self.tool_registry.register("browser_type", self.browser_agent.browser_type)
        self.tool_registry.register("browser_press", self.browser_agent.browser_press)
        ...
        async def _apply_task_fix(task_id):
            if self.automation_engine:
                success, msg = await self.automation_engine.apply_fix(task_id)
                return msg
