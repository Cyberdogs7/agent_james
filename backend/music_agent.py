...
class MusicAgent:
    ...
    def _process_chunk(self, process_data):
        """Processes an audio chunk: applies volume, visualizer logic, and pushes to queue."""
    ...
    def _stream_reader_sync(self, internal_queue, stop_event):
        ...
        while self.is_playing and internal_queue is self.internal_queue:
            ...
            process_data = self._process_chunk(process_data)
