...
class SearchAgent:
    ...
    async def search(self, query: str):
        ...
        chat_history_results_task = asyncio.create_task(asyncio.to_thread(self.project_manager.search_chat_history, query))
        ...
        # Wait for all tasks
        await asyncio.gather(trello_results_task, local_files_results_task, chat_history_results_task, web_results_task)

        return {
            "trello": trello_results_task.result(),
            "local_files": local_files_results_task.result(),
            "chat_history": chat_history_results_task.result(),
